...
func (s *SubscriptionsCollectionDocumentApiService) AMFStatusChangeSubscribe(ctx context.Context, subscriptionData amfmodel.SubscriptionData) (amfcommon.ImplResponse, error) {
	// TODO - update AMFStatusChangeSubscribe with the required logic for this service method.
	...
	//TODO: Uncomment the next line to return response amfcommon.Response(201, amfmodel.SubscriptionData{}) or use other options such as http.Ok ...
	//return amfcommon.Response(201, amfmodel.SubscriptionData{}), nil
	...
	return amfcommon.Response(http.StatusNotImplemented, nil), errors.New("AMFStatusChangeSubscribe method not implemented")
}
