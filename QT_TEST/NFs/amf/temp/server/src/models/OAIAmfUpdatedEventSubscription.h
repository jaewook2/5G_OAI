...
/*
 * OAIAmfUpdatedEventSubscription.h
 *
 * 
 */

#ifndef OAIAmfUpdatedEventSubscription_H
#define OAIAmfUpdatedEventSubscription_H
...
class OAIAmfUpdatedEventSubscription : public OAIObject {
public:
    OAIAmfUpdatedEventSubscription();
    OAIAmfUpdatedEventSubscription(QString json);
    ~OAIAmfUpdatedEventSubscription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAmfUpdatedEventSubscription)

#endif // OAIAmfUpdatedEventSubscription_H
