...
#ifndef OAILteV2xAuth_H
#define OAILteV2xAuth_H
...
class OAILteV2xAuth : public OAIObject {
public:
    OAILteV2xAuth();
    OAILteV2xAuth(QString json);
    ~OAILteV2xAuth() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILteV2xAuth)

#endif // OAILteV2xAuth_H
