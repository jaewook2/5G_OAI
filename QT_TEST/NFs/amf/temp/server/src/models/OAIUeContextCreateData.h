...
/*
 * OAIUeContextCreateData.h
 *
 * 
 */

#ifndef OAIUeContextCreateData_H
#define OAIUeContextCreateData_H
...
class OAIUeContextCreateData : public OAIObject {
public:
    OAIUeContextCreateData();
    OAIUeContextCreateData(QString json);
    ~OAIUeContextCreateData() override;
    ...
    QString getN2NotifyUri() const;
    void setN2NotifyUri(const QString &n2_notify_uri);
    bool is_n2_notify_uri_Set() const;
    bool is_n2_notify_uri_Valid() const;
    ...
    OAIPlmnIdNid getServingNetwork() const;
    void setServingNetwork(const OAIPlmnIdNid &serving_network);
    bool is_serving_network_Set() const;
    bool is_serving_network_Valid() const;
...
private:
    ...
    QString n2_notify_uri;
    bool m_n2_notify_uri_isSet;
    bool m_n2_notify_uri_isValid;
    ...
    OAIPlmnIdNid serving_network;
    bool m_serving_network_isSet;
    bool m_serving_network_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUeContextCreateData)

#endif // OAIUeContextCreateData_H
