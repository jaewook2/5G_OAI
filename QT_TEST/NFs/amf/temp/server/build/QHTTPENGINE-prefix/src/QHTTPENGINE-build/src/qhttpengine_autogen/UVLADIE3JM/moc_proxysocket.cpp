...
void ProxySocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ProxySocket *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ProxySocket::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_ProxySocket.data,
    qt_meta_data_ProxySocket,
    qt_static_metacall,
    nullptr,
    nullptr
} };
