...
struct qt_meta_stringdata_QHttpEngine__Socket_t {
    QByteArrayData data[4];
    char stringdata0[48];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QHttpEngine__Socket_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QHttpEngine__Socket_t qt_meta_stringdata_QHttpEngine__Socket = {
    {
QT_MOC_LITERAL(0, 0, 19), // "QHttpEngine::Socket"
QT_MOC_LITERAL(1, 20, 13), // "headersParsed"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 12) // "disconnected"

    },
    "QHttpEngine::Socket\0headersParsed\0\0"
    "disconnected"
};
...
void *QHttpEngine::Socket::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_QHttpEngine__Socket.stringdata0))
        return static_cast<void*>(this);
    return QIODevice::qt_metacast(_clname);
}

int QHttpEngine::Socket::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 1
void QHttpEngine::Socket::disconnected()
{
