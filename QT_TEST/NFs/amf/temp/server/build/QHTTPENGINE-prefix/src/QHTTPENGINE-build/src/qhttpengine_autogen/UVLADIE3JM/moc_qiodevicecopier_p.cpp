...
void QHttpEngine::QIODeviceCopierPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QIODeviceCopierPrivate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QHttpEngine::QIODeviceCopierPrivate::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QHttpEngine__QIODeviceCopierPrivate.data,
    qt_meta_data_QHttpEngine__QIODeviceCopierPrivate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
