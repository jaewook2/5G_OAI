...
void OpenAPI::OAIApiRequestHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OAIApiRequestHandler *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (OAIApiRequestHandler::*)(QHttpEngine::Socket * );
...
QT_INIT_METAOBJECT const QMetaObject OpenAPI::OAIApiRequestHandler::staticMetaObject = { {
    &QHttpEngine::QObjectHandler::staticMetaObject,
    qt_meta_stringdata_OpenAPI__OAIApiRequestHandler.data,
    qt_meta_data_OpenAPI__OAIApiRequestHandler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject OpenAPI::OAIApiRouter::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_OpenAPI__OAIApiRouter.data,
    qt_meta_data_OpenAPI__OAIApiRouter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
