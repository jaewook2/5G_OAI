...
QT_INIT_METAOBJECT const QMetaObject QHttpEngine::Handler::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QHttpEngine__Handler.data,
    qt_meta_data_QHttpEngine__Handler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
