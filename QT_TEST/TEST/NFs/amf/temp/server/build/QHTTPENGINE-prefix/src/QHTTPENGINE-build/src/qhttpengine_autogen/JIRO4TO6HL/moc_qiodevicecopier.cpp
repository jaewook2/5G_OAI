...
struct qt_meta_stringdata_QHttpEngine__QIODeviceCopier_t {
    QByteArrayData data[7];
    char stringdata0[64];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QHttpEngine__QIODeviceCopier_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QHttpEngine__QIODeviceCopier_t qt_meta_stringdata_QHttpEngine__QIODeviceCopier = {
    {
QT_MOC_LITERAL(0, 0, 28), // "QHttpEngine::QIODeviceCopier"
...
QT_MOC_LITERAL(6, 59, 4) // "stop"
    ...
    "QHttpEngine::QIODeviceCopier\0error\0\0"
    "message\0finished\0start\0stop"
};
...
void *QHttpEngine::QIODeviceCopier::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_QHttpEngine__QIODeviceCopier.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}

int QHttpEngine::QIODeviceCopier::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void QHttpEngine::QIODeviceCopier::error(const QString & _t1)
{
...
// SIGNAL 1
void QHttpEngine::QIODeviceCopier::finished()
{
