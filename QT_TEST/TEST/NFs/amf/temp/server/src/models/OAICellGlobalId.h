...
#ifndef OAICellGlobalId_H
#define OAICellGlobalId_H
...
class OAICellGlobalId : public OAIObject {
public:
    OAICellGlobalId();
    OAICellGlobalId(QString json);
    ~OAICellGlobalId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICellGlobalId)

#endif // OAICellGlobalId_H
