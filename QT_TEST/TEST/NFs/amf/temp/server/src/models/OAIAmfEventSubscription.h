...
/*
 * OAIAmfEventSubscription.h
 *
 * 
 */

#ifndef OAIAmfEventSubscription_H
#define OAIAmfEventSubscription_H
...
class OAIAmfEventSubscription : public OAIObject {
public:
    OAIAmfEventSubscription();
    OAIAmfEventSubscription(QString json);
    ~OAIAmfEventSubscription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAmfEventSubscription)

#endif // OAIAmfEventSubscription_H
